    ...
    return (
        ...
        >
            ...
            <div className="w-full flex-1 flex flex-col items-center justify-center">
                ...
                (item.thumbnailUrl || item.previewUrl || (item.s3Key && item.fileType !== 'raw')) ? 
                <img 
                    src={item.thumbnailUrl || item.previewUrl || ((item.s3Key && item.fileType !== 'raw') ? getPublicUrl(item.s3Key) : undefined)} 
                    alt={item.name} 
