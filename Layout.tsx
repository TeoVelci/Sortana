        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex items-center">
            <button 
              ...
              className="relative w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 dark:bg-dark-700 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
            >
